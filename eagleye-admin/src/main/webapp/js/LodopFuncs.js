...
**************************/
		...
		var basePath = loc.protocol+"//"+loc.host+"/"+webName;
        var strHtmInstall="<br><font color='#FF00FF'>打印控件未安装!点击这里<a href='"+basePath+"/software/install_lodop32.exe'>执行安装</a>,安装后请刷新页面或重新进入。</font>";
        var strHtmUpdate="<br><font color='#FF00FF'>打印控件需要升级!点击这里<a href='"+basePath+"/software/install_lodop32.exe'>执行升级</a>,升级后请重新进入。</font>";
        var strHtm64_Install="<br><font color='#FF00FF'>打印控件未安装!点击这里<a href='"+basePath+"/software/install_lodop64.exe'>执行安装</a>,安装后请刷新页面或重新进入。</font>";
        var strHtm64_Update="<br><font color='#FF00FF'>打印控件需要升级!点击这里<a href='"+basePath+"/software/install_lodop64.exe'>执行升级</a>,升级后请重新进入。</font>";
