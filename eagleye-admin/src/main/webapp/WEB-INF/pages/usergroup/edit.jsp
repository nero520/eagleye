...
<div class="col-lg-12">
    <div class="well bs-component">
        <form class="form-horizontal" id="myForm" action="<%=basePath %>/usergroup/update.html" method="post">
            <fieldset>
                <legend></legend>
                        ...
                        <select id="userId" name="userId" class="form-control" id="select">
                            <c:forEach items="${userList}" var="item">
                                <option value="${item.id}"
                                        <c:if test="${item.id==userGroup.userId}">selected</c:if> >
                ...
                <%--<div class="col-lg-10">--%>
                <%--<input type="text" class="form-control inputxt" value="${userGroup.userPhone }" id="userPhone"--%>
                <%--name="userPhone" placeholder="" datatype="m" nullmsg="请输入手机号" errormsg="请输入正确的手机号码"/>--%>
                <%--</div>--%>
                <%--</div>--%>
                <div class="form-group">
