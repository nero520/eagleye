...
$(document).ready(function() {
	var url = "<%=basePath%>usergroup/"+${groupId}+"/querySimple.html";
	...
	oTable = $('#example').dataTable( {
		...
		"aoColumns":[
			...
			{"mDataProp":"id","sTitle":"ID","sClass":"center"},
				{"mDataProp":"userAccount","sTitle":"用户邮箱","sClass":"center"},
				{"mDataProp":"userPhone","sTitle":"用户手机","sClass":"center"},
				{	"mDataProp":"warnType",
					"sTitle":"预警方式",
					"sClass":"center",
...
var deleteUrl="<%=basePath%>usergroup/destroy/{id}.html";
var editUrl="<%=basePath%>usergroup/{id}/edit.html";
var addUrl="<%=basePath%>usergroup/{groupId}/add.html";
var detailUrl="<%=basePath%>usergroup/show/{id}.html";
...
$(function(){
	$(".add").click(function(){
		...
		common.frame(addUrl.replace(/{groupId}/ig,groupId), '新增','690','250');
		//$("#example").css("width","1098");
	});
	
	$(".edit").live("click",function(){
		var id=$(this).attr("editId");
		common.frame(editUrl.replace(/{id}/ig,id), '修改','690','250');
	});
	
	$(".detail").live("click",function(){
		var id=$(this).attr("detailId");
		common.frame(detailUrl.replace(/{id}/ig,id),"详情",'690','250');
	});
