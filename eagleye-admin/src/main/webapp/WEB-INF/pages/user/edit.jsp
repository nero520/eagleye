...
<div class="well bs-component">
    <form class="form-horizontal" id="myForm" action="<%=basePath %>/user/update.html" method="post">
        <br>
        ...
        <div class="form-group">
            ...
            <div class="col-lg-9">
                <input type="text" class="form-control inputxt" id="userName" name="userName" placeholder=""
                       nullmsg="请输入姓名" datatype="s1-16" errormsg="姓名1-16个字符之间" value="${user.userName}">
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-lg-9">
                <input type="text" class="form-control inputxt" id="userAccount" name="userAccount" placeholder=""
                       nullmsg="请输入邮箱" errormsg="邮箱6-32个字符之间" value="${user.userAccount}"/>
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-lg-9">
                <input type="text" class="form-control inputxt" id="userPhone" name="userPhone" placeholder=""
                       nullmsg="请输入手机" datatype="s1-11" errormsg="1-11个字符之间" value="${user.userPhone}"/>
            </div>
        </div>
        <div class="form-group">
