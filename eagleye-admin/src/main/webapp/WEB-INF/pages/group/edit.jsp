    ...
    <form class="form-horizontal" id="myForm" action="<%=basePath %>/group/update.html" method="post">
      <fieldset>
        ...
        <div class="form-group">
          ...
          <div class="col-lg-10">
            <input type="text" value="${group.groupName}" class="form-control inputxt" id="groupName" name="groupName" placeholder="" datatype="s1-20" nullmsg="请输入名称" errormsg="名称1-20个字符之间" />
        	</div>
        </div>
        <div class="form-group">
          <label class="col-lg-2 control-label">备注:</label>
          <div class="col-lg-10">
            <textarea class="form-control" rows="3" id="description" name="description" datatype="s0-100" errormsg="备注在100个字符之内">${group.description}</textarea>
          </div>
        </div>
