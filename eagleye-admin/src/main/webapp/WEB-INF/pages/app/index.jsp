...
$(document).ready(function() {
	var url = "<%=basePath%>app/querySimple.html";
	...
	oTable = $('#example').dataTable( {
		...
		"aoColumns":[
			...
			{"mDataProp":"id","sTitle":"ID","sClass":"center"},
				{"mDataProp":"appName","sTitle":"应用名称","sClass":"center"},
...
var deleteUrl="<%=basePath%>app/destroy/{id}.html";
var editUrl="<%=basePath%>app/{id}/edit.html";
var addUrl="<%=basePath%>app/add.html";
var detailUrl="<%=basePath%>app/show/{id}.html";
...
$(function(){
	$(".add").click(function(){
		common.frame(addUrl, '新增应用','690','400');
