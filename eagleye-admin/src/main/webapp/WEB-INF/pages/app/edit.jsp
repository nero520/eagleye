    ...
    <form class="form-horizontal" id="myForm" action="<%=basePath %>/app/update.html" method="post">
      <fieldset>
        ...
        <div class="form-group">
          ...
          <div class="col-lg-10">
            <input type="text" value="${app.appName}" class="form-control inputxt" id="appName" name="appName" placeholder="" />
        	</div>
        </div>
        <div class="form-group">
          <label class="col-lg-2 control-label">备注:</label>
          <div class="col-lg-10">
            <textarea class="form-control" rows="3" id="description" name="description" datatype="s0-100" errormsg="备注在100个字符之内">${app.description}</textarea>
          </div>
        </div>
