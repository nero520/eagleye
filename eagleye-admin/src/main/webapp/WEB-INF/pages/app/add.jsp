...
<div class="col-lg-12">
  <div class="well bs-component">
    <form class="form-horizontal" id="myForm" action="<%=basePath %>/app/create.html" method="post">
      <fieldset>
        <legend></legend>
        <div class="form-group">
          <label class="col-lg-2 control-label">名称:</label>
          <div class="col-lg-10">
            <input type="text" class="form-control inputxt" id="appName" name="appName" placeholder="" />
        	</div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
          <label for="select" class="col-lg-2 control-label">成员:</label>
          <div class="col-lg-10">
