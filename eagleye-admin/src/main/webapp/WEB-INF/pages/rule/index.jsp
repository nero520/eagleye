...
$(document).ready(function() {
	var url = "<%=basePath%>rule/querySimple.html";
	...
	oTable = $('#example').dataTable( {
		...
		"aoColumns":[
			...
			{"mDataProp":"id","sTitle":"ID","sClass":"center"},
				{"mDataProp":"ruleKeyword","sTitle":"预警规则","sClass":"center"},
...
var deleteUrl="<%=basePath%>rule/destroy/{id}.html";
var editUrl="<%=basePath%>rule/{id}/edit.html";
var addUrl="<%=basePath%>rule/add.html";
var detailUrl="<%=basePath%>rule/show/{id}.html";
...
$(function(){
	$(".add").click(function(){
		common.frame(addUrl, '新增','690','400');
		//$("#example").css("width","1098");
	});
	
	$(".edit").live("click",function(){
		var id=$(this).attr("editId");
		common.frame(editUrl.replace(/{id}/ig,id), '修改','690','400');
	});
	
	$(".detail").live("click",function(){
		var id=$(this).attr("detailId");
		common.frame(detailUrl.replace(/{id}/ig,id),"详情",'690','350');
	});
