...
<div class="col-lg-12">
  <div class="well bs-component">
    <form class="form-horizontal" id="myForm" action="<%=basePath %>/rule/create.html" method="post">
      <fieldset>
        <legend></legend>
        <div class="form-group">
          <label class="col-lg-2 control-label">关键字:</label>
          <div class="col-lg-10">
            <input type="text" class="form-control inputxt" id="ruleKeyword" name="ruleKeyword" placeholder="" datatype="s1-100" nullmsg="请输入名称" errormsg="名称1-100个字符之间" />
        	</div>
        </div>
        <div class="form-group">
