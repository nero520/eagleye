...
//			if(sSearchStr == null||typeof(sSearchStr)==undefined){
//				sSearchStr ="";
//			}
			sSearchStr = (sSearchStr.indexOf('_INPUT_') !== -1) ?
			  sSearchStr.replace('_INPUT_', '<input type="text" name="queryString" class="search" defaultvalue='+sSearchStr +' />') : '<input type="text" name="queryString" class="search" defaultvalue='+sSearchStr +' />';
			  //sSearchStr==="" ? '<input type="text" class="search" defaultvalue='+sSearchStr +' />' : sSearchStr+' <input type="text" class="search"/>';
			var nFilter = document.createElement( 'div' );
			nFilter.className = oSettings.oClasses.sFilter;
			//modified by zcp for fire search on click button
			//nFilter.innerHTML = '<label>'+sSearchStr+'</label>';
			nFilter.innerHTML = '<div class="search-bg fang">'+sSearchStr+'<span class="showValue"></span><div class="search_en"><a href="javascript:void(0)"></a></div></div>';
			...
			$("a",$(".search_en")).live("click",function(){
					_fnFilterComplete( oSettings, { 
						"sSearch": jqFilter.val(), 
			...
			//文本框改变 搜索按钮能触发点击事件
			jqFilter.bind( 'change.DT', function(e) {
				...
				//modified by zcp for fire search on click button
				/**
				$('a', nFilter).unbind("click").click(function()
				 Now do the filter 
		...
		return this.each(function() {
			...
			if ( oInit.bJQueryUI )
			{
				...
				if ( oInit.sDom === DataTable.defaults.sDom && DataTable.defaults.sDom === "frtipl" )
				{
					/* Set the DOM to use a layout suitable for jQuery UI's theming */
					oSettings.sDom = '<"H"fr>t<"F"ipl>';
				}
			}
			else
			{
	...
	DataTable.defaults = {
		...
		"fnServerData": function ( sUrl, aoData, fnCallback, oSettings ) {
			sUrl=$.isFunction(sUrl)?sUrl():sUrl;
			oSettings.jqXHR=common.send(sUrl,aoData,function(json){
