...
public class ShortUrlGenerator {
    ...
    * 生成短链接字符串,长度为24位
    * @param rawStr 原始链接串
    * @param salt 加密盐,一般可以用登录名
    * @return
    */
   public static String generateShortUrl(String rawStr,String salt){
	   String returnResult = "";
	   for(String str : ShortUrlGenerator.shortUrl(rawStr, salt)){
		   returnResult +=str;
	   }
	   return returnResult;
   }
    ...
    * @param url 原始链接串
    * @param salt 加密盐,一般可以用登录名
    * @return 长度为4的数组,其中数组中任意成员都可作为短链接地址
    */
   public static String[] shortUrl(String url,String salt) {
      ...
      // 对传入网址进行 MD5 加密
      String sMD5EncryptResult = new Md5PwdEncoder().encryptPassword(url, key);
  ...
  public static void main(String[] args) {
     ...
     String[] aResult = ShortUrlGenerator.shortUrl (sLongUrl,"123");
     // 打印出结果
